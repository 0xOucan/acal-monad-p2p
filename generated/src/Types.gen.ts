...
export type AcalEscrow_OrderCreated_eventFilter = { readonly orderId?: SingleOrMultiple_t<bigint>; readonly maker?: SingleOrMultiple_t<Address_t> };
...
export type AcalEscrow_OrderLocked_eventArgs = { readonly orderId: bigint; readonly taker: Address_t };
...
export type AcalEscrow_OrderLocked_eventFilter = { readonly orderId?: SingleOrMultiple_t<bigint>; readonly taker?: SingleOrMultiple_t<Address_t> };
...
export type AcalEscrow_OrderCompleted_eventArgs = { readonly orderId: bigint };
...
export type AcalEscrow_OrderCompleted_eventFilter = { readonly orderId?: SingleOrMultiple_t<bigint> };
...
export type AcalEscrow_OrderCancelled_eventArgs = { readonly orderId: bigint };

export type AcalEscrow_OrderCancelled_block = Block_t;

export type AcalEscrow_OrderCancelled_transaction = Transaction_t;

export type AcalEscrow_OrderCancelled_event = {
  /** The parameters or arguments associated with this event. */
  readonly params: AcalEscrow_OrderCancelled_eventArgs; 
  /** The unique identifier of the blockchain network where this event occurred. */
  readonly chainId: AcalEscrow_chainId; 
  /** The address of the contract that emitted this event. */
  readonly srcAddress: Address_t; 
  ...
  readonly logIndex: number; 
  /** The transaction that triggered this event. Configurable in `config.yaml` via the `field_selection` option. */
  readonly transaction: AcalEscrow_OrderCancelled_transaction; 
  /** The block in which this event was recorded. Configurable in `config.yaml` via the `field_selection` option. */
  readonly block: AcalEscrow_OrderCancelled_block
};

export type AcalEscrow_OrderCancelled_loaderArgs = Internal_genericLoaderArgs<AcalEscrow_OrderCancelled_event,loaderContext>;

export type AcalEscrow_OrderCancelled_loader<loaderReturn> = Internal_genericLoader<AcalEscrow_OrderCancelled_loaderArgs,loaderReturn>;

export type AcalEscrow_OrderCancelled_handlerArgs<loaderReturn> = Internal_genericHandlerArgs<AcalEscrow_OrderCancelled_event,handlerContext,loaderReturn>;

export type AcalEscrow_OrderCancelled_handler<loaderReturn> = Internal_genericHandler<AcalEscrow_OrderCancelled_handlerArgs<loaderReturn>>;

export type AcalEscrow_OrderCancelled_contractRegister = Internal_genericContractRegister<Internal_genericContractRegisterArgs<AcalEscrow_OrderCancelled_event,contractRegistrations>>;

export type AcalEscrow_OrderCancelled_eventFilter = { readonly orderId?: SingleOrMultiple_t<bigint> };

export type AcalEscrow_OrderCancelled_eventFiltersArgs = { 
/** The unique identifier of the blockchain network where this event occurred. */
readonly chainId: AcalEscrow_chainId; 
/** Addresses of the contracts indexing the event. */
readonly addresses: Address_t[] };

export type AcalEscrow_OrderCancelled_eventFiltersDefinition = 
    AcalEscrow_OrderCancelled_eventFilter
  | AcalEscrow_OrderCancelled_eventFilter[];

export type AcalEscrow_OrderCancelled_eventFilters = 
    AcalEscrow_OrderCancelled_eventFilter
  | AcalEscrow_OrderCancelled_eventFilter[]
  | ((_1:AcalEscrow_OrderCancelled_eventFiltersArgs) => AcalEscrow_OrderCancelled_eventFiltersDefinition);

export type AcalEscrow_OrderDisputed_eventArgs = { readonly orderId: bigint };

export type AcalEscrow_OrderDisputed_block = Block_t;

export type AcalEscrow_OrderDisputed_transaction = Transaction_t;

export type AcalEscrow_OrderDisputed_event = {
  /** The parameters or arguments associated with this event. */
  readonly params: AcalEscrow_OrderDisputed_eventArgs; 
  /** The unique identifier of the blockchain network where this event occurred. */
  readonly chainId: AcalEscrow_chainId; 
  /** The address of the contract that emitted this event. */
  readonly srcAddress: Address_t; 
  ...
  readonly logIndex: number; 
  /** The transaction that triggered this event. Configurable in `config.yaml` via the `field_selection` option. */
  readonly transaction: AcalEscrow_OrderDisputed_transaction; 
  /** The block in which this event was recorded. Configurable in `config.yaml` via the `field_selection` option. */
  readonly block: AcalEscrow_OrderDisputed_block
};

export type AcalEscrow_OrderDisputed_loaderArgs = Internal_genericLoaderArgs<AcalEscrow_OrderDisputed_event,loaderContext>;

export type AcalEscrow_OrderDisputed_loader<loaderReturn> = Internal_genericLoader<AcalEscrow_OrderDisputed_loaderArgs,loaderReturn>;

export type AcalEscrow_OrderDisputed_handlerArgs<loaderReturn> = Internal_genericHandlerArgs<AcalEscrow_OrderDisputed_event,handlerContext,loaderReturn>;

export type AcalEscrow_OrderDisputed_handler<loaderReturn> = Internal_genericHandler<AcalEscrow_OrderDisputed_handlerArgs<loaderReturn>>;

export type AcalEscrow_OrderDisputed_contractRegister = Internal_genericContractRegister<Internal_genericContractRegisterArgs<AcalEscrow_OrderDisputed_event,contractRegistrations>>;

export type AcalEscrow_OrderDisputed_eventFilter = { readonly orderId?: SingleOrMultiple_t<bigint> };

export type AcalEscrow_OrderDisputed_eventFiltersArgs = { 
/** The unique identifier of the blockchain network where this event occurred. */
readonly chainId: AcalEscrow_chainId; 
/** Addresses of the contracts indexing the event. */
readonly addresses: Address_t[] };

export type AcalEscrow_OrderDisputed_eventFiltersDefinition = 
    AcalEscrow_OrderDisputed_eventFilter
  | AcalEscrow_OrderDisputed_eventFilter[];

export type AcalEscrow_OrderDisputed_eventFilters = 
    AcalEscrow_OrderDisputed_eventFilter
  | AcalEscrow_OrderDisputed_eventFilter[]
  | ((_1:AcalEscrow_OrderDisputed_eventFiltersArgs) => AcalEscrow_OrderDisputed_eventFiltersDefinition);
