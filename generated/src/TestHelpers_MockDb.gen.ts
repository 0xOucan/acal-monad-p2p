...
export type entities = {
  readonly GlobalStats: entityStoreOperations<Entities_GlobalStats_t>; 
  readonly Order: entityStoreOperations<Entities_Order_t>; 
  readonly OrderEvent: entityStoreOperations<Entities_OrderEvent_t>
};
