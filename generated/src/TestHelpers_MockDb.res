...
@genType
and entities = {
    @as("GlobalStats") globalStats: entityStoreOperations<Entities.GlobalStats.t>,
    @as("Order") order: entityStoreOperations<Entities.Order.t>,
    @as("OrderEvent") orderEvent: entityStoreOperations<Entities.OrderEvent.t>,
  }
  ...
  let entities = {
      globalStats: {
        makeStoreOperatorEntity(
          ...
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.GlobalStats)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.GlobalStats.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      order: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.Order)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.Order.t,
            >
      ...
      orderEvent: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.OrderEvent)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.OrderEvent.t,
            >
          ),
          ~getKey=({id}) => id,
        )
