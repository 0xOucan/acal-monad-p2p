...
import type {AcalEscrow_OrderCancelled_eventFilters as Types_AcalEscrow_OrderCancelled_eventFilters} from './Types.gen';
...
import type {AcalEscrow_OrderDisputed_eventFilters as Types_AcalEscrow_OrderDisputed_eventFilters} from './Types.gen';
...
export const AcalEscrow_OrderCancelled_contractRegister: Types_fnWithEventConfig<Internal_genericContractRegister<Internal_genericContractRegisterArgs<Types_AcalEscrow_OrderCancelled_event,Types_contractRegistrations>>,Types_HandlerTypes_eventConfig<Types_AcalEscrow_OrderCancelled_eventFilters>> = HandlersJS.AcalEscrow.OrderCancelled.contractRegister as any;

export const AcalEscrow_OrderCancelled_handler: Types_fnWithEventConfig<Internal_genericHandler<Internal_genericHandlerArgs<Types_AcalEscrow_OrderCancelled_event,Types_handlerContext,void>>,Types_HandlerTypes_eventConfig<Types_AcalEscrow_OrderCancelled_eventFilters>> = HandlersJS.AcalEscrow.OrderCancelled.handler as any;

export const AcalEscrow_OrderCancelled_handlerWithLoader: <loaderReturn>(_1:Internal_genericHandlerWithLoader<Internal_genericLoader<Internal_genericLoaderArgs<Types_AcalEscrow_OrderCancelled_event,Types_loaderContext>,loaderReturn>,Internal_genericHandler<Internal_genericHandlerArgs<Types_AcalEscrow_OrderCancelled_event,Types_handlerContext,loaderReturn>>,Types_AcalEscrow_OrderCancelled_eventFilters>) => void = HandlersJS.AcalEscrow.OrderCancelled.handlerWithLoader as any;

export const AcalEscrow_OrderDisputed_contractRegister: Types_fnWithEventConfig<Internal_genericContractRegister<Internal_genericContractRegisterArgs<Types_AcalEscrow_OrderDisputed_event,Types_contractRegistrations>>,Types_HandlerTypes_eventConfig<Types_AcalEscrow_OrderDisputed_eventFilters>> = HandlersJS.AcalEscrow.OrderDisputed.contractRegister as any;

export const AcalEscrow_OrderDisputed_handler: Types_fnWithEventConfig<Internal_genericHandler<Internal_genericHandlerArgs<Types_AcalEscrow_OrderDisputed_event,Types_handlerContext,void>>,Types_HandlerTypes_eventConfig<Types_AcalEscrow_OrderDisputed_eventFilters>> = HandlersJS.AcalEscrow.OrderDisputed.handler as any;

export const AcalEscrow_OrderDisputed_handlerWithLoader: <loaderReturn>(_1:Internal_genericHandlerWithLoader<Internal_genericLoader<Internal_genericLoaderArgs<Types_AcalEscrow_OrderDisputed_event,Types_loaderContext>,loaderReturn>,Internal_genericHandler<Internal_genericHandlerArgs<Types_AcalEscrow_OrderDisputed_event,Types_handlerContext,loaderReturn>>,Types_AcalEscrow_OrderDisputed_eventFilters>) => void = HandlersJS.AcalEscrow.OrderDisputed.handlerWithLoader as any;
...
export const AcalEscrow: {
  ...
  OrderCancelled: {
    handlerWithLoader: <loaderReturn>(_1:Internal_genericHandlerWithLoader<Internal_genericLoader<Internal_genericLoaderArgs<Types_AcalEscrow_OrderCancelled_event,Types_loaderContext>,loaderReturn>,Internal_genericHandler<Internal_genericHandlerArgs<Types_AcalEscrow_OrderCancelled_event,Types_handlerContext,loaderReturn>>,Types_AcalEscrow_OrderCancelled_eventFilters>) => void; 
    handler: Types_fnWithEventConfig<Internal_genericHandler<Internal_genericHandlerArgs<Types_AcalEscrow_OrderCancelled_event,Types_handlerContext,void>>,Types_HandlerTypes_eventConfig<Types_AcalEscrow_OrderCancelled_eventFilters>>; 
    contractRegister: Types_fnWithEventConfig<Internal_genericContractRegister<Internal_genericContractRegisterArgs<Types_AcalEscrow_OrderCancelled_event,Types_contractRegistrations>>,Types_HandlerTypes_eventConfig<Types_AcalEscrow_OrderCancelled_eventFilters>>
  }; 
  OrderLocked: {
    handlerWithLoader: <loaderReturn>(_1:Internal_genericHandlerWithLoader<Internal_genericLoader<Internal_genericLoaderArgs<Types_AcalEscrow_OrderLocked_event,Types_loaderContext>,loaderReturn>,Internal_genericHandler<Internal_genericHandlerArgs<Types_AcalEscrow_OrderLocked_event,Types_handlerContext,loaderReturn>>,Types_AcalEscrow_OrderLocked_eventFilters>) => void; 
  ...
  OrderDisputed: {
    handlerWithLoader: <loaderReturn>(_1:Internal_genericHandlerWithLoader<Internal_genericLoader<Internal_genericLoaderArgs<Types_AcalEscrow_OrderDisputed_event,Types_loaderContext>,loaderReturn>,Internal_genericHandler<Internal_genericHandlerArgs<Types_AcalEscrow_OrderDisputed_event,Types_handlerContext,loaderReturn>>,Types_AcalEscrow_OrderDisputed_eventFilters>) => void; 
    handler: Types_fnWithEventConfig<Internal_genericHandler<Internal_genericHandlerArgs<Types_AcalEscrow_OrderDisputed_event,Types_handlerContext,void>>,Types_HandlerTypes_eventConfig<Types_AcalEscrow_OrderDisputed_eventFilters>>; 
    contractRegister: Types_fnWithEventConfig<Internal_genericContractRegister<Internal_genericContractRegisterArgs<Types_AcalEscrow_OrderDisputed_event,Types_contractRegistrations>>,Types_HandlerTypes_eventConfig<Types_AcalEscrow_OrderDisputed_eventFilters>>
  }
